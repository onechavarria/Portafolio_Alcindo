const paths = {
  ...
  architecture: '<rect x="13" y="3" width="6" height="6" rx="1"/><rect x="4" y="23" width="6" height="6" rx="1"/><rect x="22" y="23" width="6" height="6" rx="1"/><path d="M16 9v8M7 23v-6h18v6"/>',
  mobile: '<rect x="9" y="3" width="14" height="26" rx="2"/><path d="M13 7h6M15 25h2"/>',
  testing: '<path d="M10 4h12M13 4v7L6 25a3 3 0 0 0 2.7 4h14.6A3 3 0 0 0 26 25l-7-14V4M9.5 22h13M12 18h8"/>',
  cicd: '<path d="M9 10a6 6 0 1 0 0 12c4 0 7-6 7-6s3-6 7-6a6 6 0 1 1 0 12c-4 0-7-6-7-6s-3-6-7-6z"/><path d="M5 7v5h5M27 25v-5h-5"/>',
